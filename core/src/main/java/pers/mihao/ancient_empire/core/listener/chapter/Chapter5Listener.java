...
public class Chapter5Listener extends AbstractChapterListener {
    ...
    public Chapter5Listener() {
        super.triggerSites = new Site[]{new Site(10, 10), new Site(11, 11), new Site(11, 11)};
        super.maxStage = 3;
    }
    ...
    public void onChapterGameStart() {
        ...
        addDialogAndWait(DialogEnum.FRIEND_UNIT, "CAMPAIGN_AEII_STAGE_5_MESSAGE_1");
    ...
    private void triggerStage1() {
        ...
        gameContext.getHandler().addNewUnit(1, null, 2);
        gameContext.getHandler().addNewUnit(1, null, 2);
        addDialogAndWait(DialogEnum.FRIEND_UNIT, "CAMPAIGN_AEII_STAGE_5_MESSAGE_3");
    }
    ...
    private void triggerStage2() {
        ...
        addDialogAndWait(DialogEnum.FRIEND_UNIT, "CAMPAIGN_AEII_STAGE_5_MESSAGE_4");
    }
}
