...
public class Chapter2Listener extends AbstractChapterListener {
    ...
    public void onChapterGameStart() {
        ...
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_2_MESSAGE_1");
        ...
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_2_MESSAGE_5");
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_2_MESSAGE_6");
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_2_MESSAGE_7");
