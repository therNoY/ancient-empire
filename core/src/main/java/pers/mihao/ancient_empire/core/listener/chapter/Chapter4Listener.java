...
public class Chapter4Listener extends AbstractChapterListener {
    ...
    public void onChapterGameStart() {
        ...
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_4_MESSAGE_3");
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_4_MESSAGE_4");
        addDialogAndWait(DialogEnum.FRIEND_UNIT1, "CAMPAIGN_AEII_STAGE_4_MESSAGE_5");
    }
